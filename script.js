$(document).ready(function () {
    ...
    /*1. on traversing row create a row. 
      2. on traversing column create a cell.
      3.append this cell in row.
      4.now append this row in input cell container. 
    */
   ...
   $(".input-cell").blur(function(){
    ...
    $("input-call-container").scroll(function () {
